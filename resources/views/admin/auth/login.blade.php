                  ...
                  <img src="{{asset('assets/backend/images/logos/dark-logo.svg')}}" width="180" alt="">
                                ...
                                <div class="d-flex ">
                                    <div class="col-md-6 d-flex flex-column align-items-center justify-content-center text-center text-white"
                                        ...
                                        <img src="{{ asset('assets/backend/images/logos/image.png') }}" class="mb-2"
                                            width="150" alt="">
                                        <p class="fw-bold fs-4">कृषि तथा भूमि व्यवस्था मन्त्रालय</p>
                                        <p class="fw-bold fs-3">पोखरा, नेपाल </p>
                                    </div>
