...
@section('content')
    <div class="container mt-5">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="fs-4 mt-3">लिंक सम्पादन गर्नुहोस्</h4>
                            </div>
                            <div>
      ...
      <div class="card">
        <div class="container">
            <form class="row" action="{{ route('admin.link.update', $link) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="col-md-6 fs-4 mt-4">
                    <label for="title" class="form-label">शीर्षक</label>
                    <input type="text" class="form-control" id="title" value="{{ old('title', $link->title) }}"
                        name="title" required>
                </div>
                <div class="col-md-6 fs-4 mt-4">
                    <label for="title_en" class="form-label">शीर्षक अंग्रेजीमा</label>
                    <input type="text" class="form-control" id="title_en" value="{{ old('title_en', $link->title_en) }}"
