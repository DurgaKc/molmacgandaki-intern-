...
@section('content')
    <div class="container mt-5">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class=" d-flex justify-content-between">
                            <div>
                                <h4 class="fs-4 mt-3">कानून थप्नुहोस</h4>
                            </div>
                            <div>
        ...
        <div class="card">
            <div class="container">
                <form class="row" action="{{ route('admin.law.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-6 fs-3 mt-4">
                        <label for="law_category_id" class="form-label">कानून वर्ग</label>
