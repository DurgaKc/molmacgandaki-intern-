...
@section('content')
    <div class="container mt-5">
        <div class="d-flex justify-content-between">
            ...
            <div class="p-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.organization.index') }}">संगठन संरचना</a></li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="fs-4 mt-3">संगठन संरचना थप्नुहोस्</h4>
                        </div>
                        <div>
                            <a href="{{ route('admin.organization.index') }}" class="btn btn-primary align-item-end">संगठन संरचना सूची</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="container">
                <form class="row" action="{{ route('admin.organization.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
