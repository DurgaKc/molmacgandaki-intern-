...
@section('content')
    <div class="container mt-5">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class=" d-flex justify-content-between">
                            <div>
                                <h4 class="fs-4 mt-3">प्रकाशन थप्नुहोस्</h4>
                            </div>
                            <div>
                                <a href="{{ route('admin.publication.index') }}"
                                    class="btn btn-primary align-item-end">प्रकाशन सूची</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="container">
                <form class="row" action="{{ route('admin.publication.store') }}" method="POST"
                    ...
                    <div class="col-md-6 fs-3 mt-4">
                        <label for="publication_category_id" class="form-label">प्रकाशन वर्ग</label>
                        <select class="form-select" id="publication_category_id" name="publication_category_id">
                            ...
                            @foreach ($publicationCategories as $publicationCategory)
                                <option value="{{ $publicationCategory->id }}">{{ $publicationCategory->title }}</option>
                            @endforeach
                        </select>
                    </div>
