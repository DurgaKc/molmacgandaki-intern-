    ...
    <nav class="sticky-top">
        <div class="row">
            <div class="main-nav flex py-2">
                ...
                <span>
                    <a class=" fw-bold text-white mx-1" href="{{route('contact')}}">सम्पर्क</a>
                </span>
                <span>
                    <a class=" fw-bold text-white mx-1" href="{{route('subordinate')}}">मातहतका निकायहरु </a>
                </span>
                <span>
                    <input type="text" class="p-1 rounded-3 ms-3" placeholder="Search..">
